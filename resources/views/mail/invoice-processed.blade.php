...
<tr>
<td><p class="s1">Rango autorizado: {{ env('AUTHORIZED_RANGE', '000-001-01-00010001 / 000-001-01-00040000') }}</p></td>
</tr>
<tr>
...
<td style="border: 1px solid #000;"><p class="s1">{{ __($invoice->service_purchased) . ' - ' .  $invoice->transaction_ref }}</p></td>
