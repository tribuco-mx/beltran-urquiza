<x-mail::message>
    ...
    <p style="margin-top: 10px; font-size: 10pt; font-weight: bold;">Anexo factura fiscal por el servicio de mensajería
        de entrega del pasaporte.</p>
    <div class="invoice-container">
        ...
        <div style="align-items: flex-start;" class="flex-container">
            <table>
                ...
                <tr>
                    <td>
                        <p class="s1">{{ $invoice->company->address }} {{ $invoice->company->city }} {{ $invoice->company->state }}</p>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td><p class="s1">Rango
                            autorizado: {{ env('AUTHORIZED_RANGE', '000-001-01-00000001 / 000-001-01-00010000') }}</p>
                    </td>
                </tr>
                <tr>
        ...
        <table style="">
            ...
            <tr style="background-color: #F1F1F1; border: 1px solid #000;">
                <td style="width: 40px; border: 1px solid #000;"><p class="s2" style="text-align: center;">CANTIDAD</p>
                </td>
                <td style="width: 60px; border: 1px solid #000;"><p class="s2" style="text-align: center;">
                        DESCRIPCIÓN</p></td>
                <td style="width: 100px; border: 1px solid #000;"><p class="s2" style="text-align: center;">PRECIO
                        UNITARIO</p></td>
                <td style="width: 150px; border: 1px solid #000;"><p class="s2" style="text-align: center;">DESCUENTOS Y
                        REBAJAS</p></td>
                <td style="width: 120px; border: 1px solid #000;"><p class="s2" style="text-align: center;">TOTAL</p>
                </td>
            </tr>
            </thead>
            <tbody>
            <tr style="height: 250px;">
                ...
                <td style="text-align: right; border: 1px solid #000;"><p
                        class="s1">{{ number_format($invoice->amount_without_gct / $invoice->quantity, 2) }}</p></td>
                <td style="text-align: right; border: 1px solid #000;"><p class="s1">-</p></td>
                <td style="background-color: #F1F1F1; text-align: right; border: 1px solid #000;"><p
                        class="s2"> {{ number_format($invoice->amount_without_gct, 2) }}</p></td>
            </tr>
            <tr>
                <td colspan="3"></td>
        ...
        <table style="margin-top: 20px;">
            ...
            <tr>
                ...
                <td style="background-color: #F1F1F1; border-right: 1.5px solid #000; border-left: 1.5px solid #000; border-top: 1.5px solid #000;">
                    <p class="s2" style="text-align: right;">-</p></td>
            </tr>
            <tr>
                <td colspan="3"></td>
                <td><p class="s1" style="text-align: right;">Importe exento L.</p></td>
                <td style="background-color: #F1F1F1; border-right: 1.5px solid #000; border-left: 1.5px solid #000;"><p
                        class="s2" style="text-align: right;">-</p></td>
            </tr>
            <tr>
                <td colspan="3"></td>
                <td><p class="s1" style="text-align: right;">Importe gravado 15% L.</p></td>
                <td style="background-color: #F1F1F1; border-right: 1.5px solid #000; border-left: 1.5px solid #000;"><p
                        class="s2" style="text-align: right;"> {{ number_format($invoice->amount_without_gct, 2) }}</p>
                </td>
            </tr>
            <tr>
                <td colspan="3"></td>
            ...
            <tr>
                ...
                <td style="background-color: #F1F1F1; border-right: 1.5px solid #000; border-left: 1.5px solid #000;"><p
                        class="s2" style="text-align: right;">{{ number_format($invoice->gct, 2) }}</p></td>
            </tr>
            <tr>
                <td colspan="3"></td>
                <td><p class="s1" style="text-align: right;">ISV 18% L.</p></td>
                <td style="background-color: #F1F1F1;  border-right: 1.5px solid #000; border-left: 1.5px solid #000;">
                    <p class="s2" style="text-align: right;">-</p></td>
            </tr>
            <tr>
                <td colspan="3"></td>
                <td><p class="s2" style="text-align: right;">Total a pagar L.</p></td>
                <td style="background-color: #F1F1F1;  border: 2px solid #000;"><p class="s2"
                                                                                   style="text-align: right;">{{ number_format($invoice->amount_with_gct, 2) }}</p>
                </td>
            </tr>
            </tbody>
        </table>
        ...
        <table style="margin-top: 20px; ">
            ...
            <tr>
                <td style="border: 1px solid #000; width: 50%;"><p class="s1">Nro. Correlativo de la orden de compra
                        exenta:</p></td>
                <td style="border: 1px solid #000; width: 50%;"></td>
            </tr>
            <tr>
                <td style="border: 1px solid #000; width: 50%;"><p class="s1">Nro. Correlativo de la constancia del
                        registro de exonerados:</p></td>
                <td style="border: 1px solid #000; width: 50%;"></td>
            </tr>
            <tr>
                <td style="border: 1px solid #000; width: 50%;"><p class="s1">Nro. Identificativo del registro SAG</p>
                </td>
                <td style="border: 1px solid #000; width: 50%;"></td>
            </tr>
        </table>
